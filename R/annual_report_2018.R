...
######### Use of Force
uof.csv.dirty <- "data/Dante/uof_2018.csv"
...
uof.opendata.csv <- "data_public/data.nola.gov/NOPD_Use_of_Force_Incidents_20190301.csv"
...
allegations.csv.dirty <- "data/Dante/allegations_20190313.csv"
allegations.csv <- "data_public/clean/allegations_all_clean.csv"

actions.taken.csv.dirty <- "data/Dante/actions_taken_20190301.csv"
