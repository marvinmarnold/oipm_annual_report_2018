DECLARE @RELEVANT_ACTIONS TABLE (Action VARCHAR(100))

-- Add any other action types to be included here
INSERT INTO @RELEVANT_ACTIONS VALUES ('Suspension')
INSERT INTO @RELEVANT_ACTIONS VALUES ('NSA - Suspension')
INSERT INTO @RELEVANT_ACTIONS VALUES ('Suspension - reduced via civil service agreement')
INSERT INTO @RELEVANT_ACTIONS VALUES ('Suspension - Rescinded per Civil Service Agreement')
INSERT INTO @RELEVANT_ACTIONS VALUES ('Suspension - Overturned by Civil Service')
...
FROM
IA_ADM.ACTIONS_TAKEN as act
LEFT JOIN IA_ADM.ALLEGATIONS as alleg on alleg.AIO_NUM = act.AIO_NUM
LEFT JOIN IA_ADM.ASSOC_INC_OFF as ol on ol.AIO_NUM = act.AIO_NUM
LEFT JOIN IA_ADM.OFFICERS as o on o.OFFNUM = ol.OFFNUM
LEFT JOIN IA_ADM.INCIDENTS as inc on inc.INCNUM = ol.INCNUM

-- select relevant action types defined above
WHERE ACTIONTAKEN in (SELECT Action FROM @RELEVANT_ACTIONS)