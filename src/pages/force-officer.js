...
const ForcePage = () => (
	<Page
		title={"UOF by Officer Details - 2018 OIPM Annual Report"}
		nav={
		...
		body={
			<div>
				...
				<Row className="text-center">
					<Col className="py-5">
						<Button size="lg" color="secondary" className="mx-3"><a href="/force-most" className="text-white">&lt; Previous: Officers using most force</a></Button>
						<Button size="lg" color="success"><a href="/force-individual" className="text-white">Next: Force by individual details ></a></Button>
					</Col>
				</Row>
